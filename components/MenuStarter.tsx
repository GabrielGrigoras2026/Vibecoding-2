...
const menuData = {
  Espresso: [
    ...
    { name: 'Americano', price: 14, description: 'Espresso diluat cu apă caldă', image: 'https://images.unsplash.com/photo-1580933073521-dc49ac0d4e6a?w=600&auto=format&fit=crop&q=80' },
